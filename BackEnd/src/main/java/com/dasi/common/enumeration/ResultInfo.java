...
public enum ResultInfo {
    ...
    ACCOUNT_UPDATE_ERROR(1007, "账户更新失败"),
    ...
    DEPARTMENT_UPDATE_FAIL(2002, "部门更新失败"),
    ...
    CONTACT_UPDATE_FAIL(2004, "联系人更新失败"),
    CONTACT_PASSWORD_ERROR(2005, "联系人密码错误"),

    // ====== 站内信模块 ======
    MAILBOX_UPDATE_FAIL(3001, "站内信更新失败"),
    ...
    SENSITIVE_WORD_REMOVE_FAIL(5002, "敏感词删除失败"),
    SENSITIVE_WORD_UPDATE_FAIL(5003, "敏感词更新失败"),
